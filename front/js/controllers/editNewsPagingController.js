galya.controller('editNewsPagingController' ,['$scope','siteData','$location','$routeParams', function ($scope,siteData,$location,$routeParams) {
    ...
    $scope.backNewsPage = function nextNewsPage(){
       ...
       if(currentPage > 1){
           ...
           $location.path('adminPanel/editNews/'+ currentPage + "/" + $scope.years.count);
